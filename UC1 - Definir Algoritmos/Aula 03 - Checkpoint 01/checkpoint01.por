/*
 * 1. Variáveis Corretas: Use cadeia para textos, inteiro para idades, real para altura.
 * 2. Diálogo Educado: Use escreva() antes de cada leia(). O usuário não tem bola de cristal!
 * 3. Cálculo Matemático: Calcule o ano de nascimento (Ano Atual - Idade) ou o IMC da pessoa.
 * 4. Concatenação Limpa: Mostre os resultados grudando textos e variáveis com a vírgula.
 */
