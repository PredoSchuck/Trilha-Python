/*
 * 1. Definição do Saldo Crie uma variável real saldo = 1000.0 logo no início do programa.
 * 2. O Menu Use escreva para listar as opções e leia para capturar a escolha.
 * 3. A Estrutura de Decisão Use escolha caso para direcionar o usuário para cada funcionalidade.
 * 4. Validação Interna Dentro de cada "caso", use se e senao para garantir a segurança.
 */
